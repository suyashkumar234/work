...
class FewShotSeg(nn.Module):
    ...
    def forward(self, supp_imgs, fore_mask, back_mask, qry_imgs, isval, val_wsize, show_viz = False):
        ...
        for epi in range(1): # batch dimension, fixed to 1
            ...
            organ_class_teacher = torch.arange(n_ways, device=res_fg_msk_teacher.device)  # [0, 1, 2, ...] for n_ways
            organ_class_student = torch.arange(n_ways, device=res_fg_msk_student.device)  # Same for student
