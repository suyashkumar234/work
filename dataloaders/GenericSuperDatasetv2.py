...
#             img = np.float32(img)
#             #img = self.norm_func(img)
#             if self.img_modality == 'MR' or self.img_modality=='CT':
#                 img, img_mean, img_std = self.norm_func(img)
#             # Store mean and std for later use in __getitem__
#             # You'll need to add these to the data structure
#             else:
#                 img = self.norm_func(img)
...
#             'param_labels' : param_labels,
#             #edited
#             "mean": curr_dict.get("mean", img.mean().item()),
#             "std": curr_dict.get("std", img.std().item())
