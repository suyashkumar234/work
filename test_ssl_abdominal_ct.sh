...
do
    ...
    RELOAD_PATH='E:\Suyash\cowpro_contrastive\cowpro\exps\myexp_MIDDLE_0\mySSL_train_SABS_Superpix_lbgroup0_scale_MIDDLE_vfold0_SABS_Superpix_sets_0_1shot\61\snapshots\15000.pth' # path to the reloaded model
