...
def cfg():
    ...
    use_iterative_mining = True  # Enable/disable iterative hard sample mining with attention
    ...
    mining_iterations = 1  # Number of iterative mining iterations
    mining_error_threshold = 0.5  # Threshold for hard sample detection
    mining_strength = 0.2  # Blending strength for feature refinement (0.0-1.0)
