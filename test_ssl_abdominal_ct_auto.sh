...
do
    ...
    RELOAD_PATH='exps/myexp_MIDDLE_0/mySSL_train_SABS_Superpix_lbgroup0_scale_MIDDLE_vfold0_SABS_Superpix_sets_0_1shot/13/snapshots/2000.pth' # path to the reloaded model

    python3 validation.py with \
    'modelname=dlfcn_res50' \
    'usealign=True' \
    'optim_type=sgd' \
