...
def cfg():
    ...
    lr_step_gamma = 0.95
    ignore_label = 255
    print_interval = 1000  # More frequent updates for shorter runs
    ...
    # Network
    modelname = 'dlfcn_res50'  # This should work fine on M1
    clsname = 'grid_proto'
    resume = False
    ...
    path = {
        'log_dir': './runs',
        'SABS':{'data_dir': "/home/suyash.kumar.mec22.itbhu/cowpro/data/SABS/sabs_CT_normalized/"  # UPDATE THIS
            },
    ...
    DATASET_CONFIG = {'SABS':{'img_bname': f'/home/suyash.kumar.mec22.itbhu/cowpro/data/SABS/sabs_CT_normalized/image_*.nii.gz',  # UPDATE
                        'out_dir': '/home/suyash.kumar.mec22.itbhu/cowpro/data/SABS/sabs_CT_normalized/',  # UPDATE
                        'fg_thresh': 1e-4,
                        },
                      'CHAOST2':{
